...
TimerOneShot16 globl::myOneShotTimer16; // create one global instance  // Serial is not open yet

//--------------------------------------------------------------
#ifndef HIDE_ISR
ISR(TIMER1_OVF_vect) {

	TimerOneShot16& meTmr = globl::myOneShotTimer16;		// brevity
